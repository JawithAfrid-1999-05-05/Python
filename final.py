...
def draw_load_screen(progress):
    ...
    rect = (int(WINDOW_WIDTH * 0.35), int(WINDOW_HEIGHT * 0.7) - int(WINDOW_WIDTH * 0.12) - 50, int(WINDOW_WIDTH * 0.3),
    ...
    progress_bar = (
    int(WINDOW_WIDTH * 0.2 + 5), int(WINDOW_HEIGHT * 0.7 + 5), int((WINDOW_WIDTH * 0.6 - 10) * progress), 820)
...
def check_win():
    if how_many_pairs == 6:
        ...
        ctypes.windll.user32.MessageBoxW(0,
                                         "CONGRATULATION! YOU WON THE MEMMORY TILE GAME " + str(score) + " YOUR SCORE!",
                                         "GAME OVER!", 1)
